...
const baseStyle =
	'flex h-9 w-full bg-white rounded-md border border-slate-300 px-3 py-2 text-sm ring-offset-white read-only:cursor-not-allowed read-only:select-none read-only:bg-slate-100 read-only:text-slate-600 read-only:ring-offset-slate-100 focus-within:outline-none focus-within:ring-2 focus-within:ring-slate-900 focus-within:ring-offset-2 read-only:focus-within:ring-opacity-0';
