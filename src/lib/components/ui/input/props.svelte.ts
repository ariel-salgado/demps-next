...
const baseStyle =
	'flex h-9 w-full bg-white rounded-md border border-zinc-300 px-3 py-2 text-sm ring-offset-white read-only:cursor-not-allowed read-only:select-none read-only:bg-zinc-100 read-only:text-zinc-600 read-only:ring-offset-zinc-100 focus-within:outline-none focus-within:ring-2 focus-within:ring-zinc-900 focus-within:ring-offset-2 read-only:focus-within:ring-opacity-0';
